...
build/native-kernel-desktop.o: kernel/desktop.c kernel/desktop.h src/bootinfo.h build/mint_icons.raw.o tools/fix_desktop_decls.py tools/prepare_desktop.py tools/add_crd_gui.py
	mkdir -p build
